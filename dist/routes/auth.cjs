...
var Users_1 = __importDefault(require("../models/Users.cjs"));
var nodemailer_1 = __importDefault(require("nodemailer"));
var crypto_1 = __importDefault(require("crypto"));
var emailService_1 = require("../emailService.cjs");
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          generateHashedPassword = function (plainPassword) {
            return __awaiter(void 0, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    ...
                    return [
                      4 /*yield*/,
                      bcrypt_1.default.hash(plainPassword, saltRounds),
                    ];
                  case 1:
        ...
        case 4:
          ...
          return [
            ...
            (0, emailService_1.sendEmail)(
              ...
              "Your verification code is: ".concat(twoFactorCode)
            ),
          ];
        case 5:
          _b.sent();
...
router.post("/verify-2fa", function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
